...
class _AttendanceScreenState extends State<AttendanceScreen>
    ...
    try {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              '✅ Berhasil Absen ${action == 'in' ? 'Masuk' : 'Keluar'}!',
            ),
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('❌ Gagal: ${errorData['error']}'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('❌ Error: Gagal terhubung ke Server Node.js.'),
          backgroundColor: Colors.red,
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
      ...
      child: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Center(
              child: Text('Data histori absensi akan muncul di sini...'),
            ),
          ),
        ],
      ),
    ...
    // Ditambahkan Scaffold sebagai pondasi utama (agar Snackbars tidak error)
    return Scaffold(
      body: Stack(
        children: [
              ...
              child: Center(
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: const [
                      BoxShadow(color: Color(0x330EA5E9), blurRadius: 40),
                    ],
                  ),
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 20),
                      const Text(
                        'Memindai titik biometrik wajah...',
                        style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                        ),
